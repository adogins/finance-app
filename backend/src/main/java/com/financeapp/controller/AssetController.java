package com.financeaoo.controller;
...
import jakarta.perisistence.EntityNotFoundException;
...
public class AssetController {
    ...
    // GET all assets
    @GetMapping
    public List<AssetDto.Response> getAllAssets(@PathVariable Long userId, @RequestParam(required = false) String type) {
    ...
    // POST create asset
    @PostMapping
    public ResponseEntity<AssetDto.Response> createAsset(@PathVariable Long userId, @RequestBody AssetDto.Request request) {
    ...
    // PUT update asset
    @PutMapping("/{id}")
    public AssetDto.Response updateAsset(@PathVariable Long userId, @PathVariable Long id, @RequestBody AssetDto.Request request) {
        findUserOrThrow(userId);
